...
namespace TooliRent.Infrastructure.Migrations
{
    ...
    [Migration("20251001162352_SyncUserWithoutRefreshToken")]
    partial class SyncUserWithoutRefreshToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TooliRent.Domain.Models.BookingTool", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TooliRent.Domain.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TooliRent.Domain.Models.Booking", b =>
                {
                    b.HasOne("TooliRent.Domain.Models.Tool", null)
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("TooliRent.Domain.Models.BookingTool", b =>
                {
                    b.HasOne("TooliRent.Domain.Models.Booking", "Booking")
